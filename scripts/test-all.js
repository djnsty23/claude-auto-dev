...
// Discovers every scripts/test-*.js suite (excluding itself), runs each in its
...
// Run: node scripts/test-all.js   (or: npm test)
...
console.log(`\n=== validate ===`);
run('validate', [...CHILD_FLAGS, path.join(repoRoot, 'validate.js')]);
