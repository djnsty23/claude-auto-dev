...
function valid(overrides = {}) {
    return Object.assign({
        ...
        assertion: { subject: 'dom', claim: 'exactly one generated image with a data: src is rendered', expected: 1 },
        observed: 1,
...
const cases = [
    ...
    ['no expected value is refused', valid({ assertion: { subject: 'dom', claim: 'one generated image rendered' } }), 2, 'assertion.expected'],
    ['a null expected value is refused', valid({ assertion: { subject: 'dom', claim: 'one generated image rendered', expected: null } }), 2, 'assertion.expected'],
