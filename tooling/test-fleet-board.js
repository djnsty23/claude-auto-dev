'use strict';
// Suite for plugins/autodev-core/scripts/fleet-board.js.
//
...
const SUBJECT = path.join(__dirname, '..', 'plugins', 'autodev-core', 'scripts', 'fleet-board.js');
...
let tmp = null;
try {
    tmp = fs.mkdtempSync(path.join(os.tmpdir(), 'fleet-board-'));
