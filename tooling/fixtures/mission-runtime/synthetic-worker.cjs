'use strict';
// Fixture-only worker forked by synthetic-adapter.cjs: registers under its bootstrap
// permit, writes exactly one owned artifact, enqueues its result, reports completion.
