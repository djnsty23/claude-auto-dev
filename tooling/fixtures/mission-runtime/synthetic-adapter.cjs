'use strict';
// Fixture-only execution port for the mission-store suites (tooling/test-mission-*.js).
// This is deliberately not a native/model adapter: it forks synthetic-worker.cjs,
// keeps the child handle, and writes an owned close receipt before touching SQLite.
// Adopted from docs/drafts/brain-live-audit/mission-runtime-v3-draft/fixtures/.
