...
- Auto-injection of area briefs (roadmap's "auto-injected when Claude touches auth files") is intentionally left as future work to keep `hooks/session-start.js` and the settings files untouched; the on-demand skill is the shipped surface.
