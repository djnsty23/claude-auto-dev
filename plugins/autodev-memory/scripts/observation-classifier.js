...
function classifyObservation(toolName, toolInput, toolResult, context) {
    ...
    // Redact before basename, path resolution or clipping can remove a privacy
    // boundary. Kept here for direct API callers as well as the PostToolUse
    // hook; the database remains the final guard.
