#!/usr/bin/env node
// The `workflow_wall_note` switch (plugin userConfig, CLAUDE_PLUGIN_OPTION_WORKFLOW_WALL_NOTE="false")
// skips this hook: it advises, it never guards. tooling/test-hooks-profile.js holds the list.
if (process.env.CLAUDE_PLUGIN_OPTION_WORKFLOW_WALL_NOTE === 'false') process.exit(0);
