#!/usr/bin/env node
/**
 * agent-browser cleanup. Registered as a SessionStart hook in hooks/hooks.json
 * (it was previously orphaned — the header claimed session-start.js invoked it,
 * but nothing did), and exposed for manual mid-session use:
 *
