#!/usr/bin/env node
'use strict';
// The `intent_record` switch (plugin userConfig, CLAUDE_PLUGIN_OPTION_INTENT_RECORD="false")
...
if (process.env.CLAUDE_PLUGIN_OPTION_INTENT_RECORD === 'false') process.exit(0);
