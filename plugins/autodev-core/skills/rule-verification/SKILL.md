...
| UI (public or admin) | Drive the affected flow in a browser with the intended role/data; verify loading, empty, error and success behavior where relevant, including persistence after reload for mutations |
