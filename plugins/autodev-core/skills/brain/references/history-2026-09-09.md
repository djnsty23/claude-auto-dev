# Historical operating notes — captured 2026-09-09

This is the previous skill body, preserved for incident evidence and recovery.
It contains superseded and contradictory instructions. It is NOT the active
operating procedure or an authorization source. Consult individual incidents
when investigating their failure class; follow the current SKILL.md and the
user’s actual instructions for actions.
