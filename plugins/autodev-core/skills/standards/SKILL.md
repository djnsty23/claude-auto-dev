---
name: standards
description: Type safety, design tokens, UI state, and React/Next.js conventions this project holds code to. Load before writing or reviewing application code.
