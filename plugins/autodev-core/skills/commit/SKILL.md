---
name: commit
description: "Commit, push and open a PR to this repo standard: a conventional subject, a body saying why the change is correct, the message passed by file rather than inline, no co-author trailer, explicit paths staged rather than everything, and the gate run before the push."
