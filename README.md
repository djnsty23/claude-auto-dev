...
[![Version](https://img.shields.io/badge/version-8.170.0-blue.svg)](https://github.com/djnsty23/claude-auto-dev/releases)
...
`@stable` pins the install to the last release. Without it the marketplace
