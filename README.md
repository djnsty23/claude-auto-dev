...
[![Version](https://img.shields.io/badge/version-7.4-blue.svg)](https://github.com/djnsty23/claude-auto-dev/releases)
...
```
You: update dev
Claude: [pulls latest, re-syncs skills/hooks/agents] Updated to v7.4
```
