#!/usr/bin/env node
/**
 * agent-browser cleanup. Auto-runs on every Claude Code SessionStart via
 * hooks/session-start.js, and exposed for manual mid-session use:
 *
 *   node "$HOME/.claude/hooks/agent-browser-cleanup.js"
 *
