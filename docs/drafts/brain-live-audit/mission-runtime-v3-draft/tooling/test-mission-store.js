#!/usr/bin/env node
'use strict';
// Actual CLI processes, exclusively disposable local Git and SQLite fixtures.
...
(async () => {
  ...
  console.log(JSON.stringify({ passed, failed: cases.length - passed, population: cases.length })); process.exitCode = passed === cases.length ? 0 : 1;
})();
